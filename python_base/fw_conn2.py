...
bytes = 'bytes'
flags = 'flags'
format_str1 = '%5s : %-20s |%10s : %-10s |%10s : %-16s|%10s : %-10s'
format_str2 = '%5s : %-20s |%10s : %-10s'
...
for key,value in asa_dict.items():
    ...
    print(format_str1 % ('src', key[0], 'src_p', key[1], 'dst', key[2], 'dst_p', key[3]))
    print(format_str2 % ('bytes', value[0], 'flags', value[1]))
    print('=' * 105)
